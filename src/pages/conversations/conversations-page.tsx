      ...
      <div className="max-w-4xl mx-auto h-full flex flex-col">
        <div className="text-center py-12 relative">
          ...
          <div className="auth-surface p-8 max-w-md mx-auto auth-animate-in relative">
            ...
            <h1 className="text-2xl font-bold text-foreground-default mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="auth-surface p-6 hover:scale-105 transition-transform cursor-pointer relative group">
            ...
            <h3 className="font-semibold text-foreground-default mb-2">
              Creative Writing
            </h3>
        ...
        <div className="auth-surface p-6 relative">
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-semibold text-foreground-default">
            ...
            {[
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <h4 className="font-medium text-foreground-default text-sm">
                    {item.title}
                  </h4>
